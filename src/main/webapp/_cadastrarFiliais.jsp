...
<html lang="PT-BR">
    ...
    <body>
        ...
        <div id="corpo">
            <form action="${pageContext.request.contextPath}/CadastrarFilial" method="post" id="formularioCadastro">
                <input type="text" name="txtNome" placeholder="NOME" class="formulario">
                </br></br>
                <input type="text" name="txtCnpj" placeholder="CNPJ - 11.111.111/1111-11" maxlength="18" class="formulario">
                </br></br>
